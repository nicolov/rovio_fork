...
class Register{
 public:
  ...
  void registerQuaternion(std::string str, Eigen::Quaternion<TYPE>& var){
    registerScalar(str + "_w",var.w());
    registerScalar(str + "_x",var.x());
    registerScalar(str + "_y",var.y());
    registerScalar(str + "_z",var.z());
  }
